        ...
        switch (activeTab) {
            case 'products': return (
                <div className="admin-content-card">
                    ...
                    <p style={{marginTop: '10px', color: 'var(--text-muted)'}}>Interface de gestion CRUD à intégrer ici.</p>
                    <button className="btn-primary" style={{marginTop: '20px', width: 'auto'}}>+ Ajouter un produit</button>
                </div>
            );
            case 'orders': return <div className="admin-content-card"><h3>🛒 Commandes récentes</h3></div>;
            case 'users': return <div className="admin-content-card"><h3>👥 Utilisateurs inscrits</h3></div>;
            default: return (
                <div className="admin-content-card">
